...
var timer = {
    ...
    // decrement: function () {
    //     timer.time--;
    //     $("#timer").html("<h3>00:"+ timer.time + "</h3>");
    // },
...
//Check answers
/////////////////////////
$(".answers-btn").on("click", checkAnswer);
...
function checkAnswer () {
    ...
    if (check === false) {
        ...
        incorrect++;
        $("#question").text("Hermione will be disappointed in your wizardry.")
        $("#answers").empty()
        timer.reset();
    }
...
function score () {
    $("#score").html (
        ...
        "<h2> You have a " + (correct/(qandA.length)) + "% chance of getting into Hogwarts!"
    )
};
